...
- **Indexing**: Basic indexes are in place, but as the `transactions` and `inventory_cost_layers` tables grow, more specialized composite indexes might be needed for reporting.
