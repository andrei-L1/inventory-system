...
const jumpToPo = (poId) => {
    router.visit(`/purchase-orders/${poId}`);
};
        ...
        <div class="p-8 bg-zinc-950 min-h-screen">
            <div class="max-w-6xl mx-auto">
                ...
                <div v-else-if="transaction" class="grid grid-cols-12 gap-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <!-- Left Section: Document Header Info -->
                            ...
                            <div class="p-8 flex flex-col gap-8">
                                ...
                                <div v-if="transaction.vendor_name" class="flex flex-col gap-2">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-sky-400 font-bold text-sm hover:underline cursor-pointer transition-all">{{ transaction.vendor_name }}</span>
                                    </div>
                                </div>
                                
                                <div v-if="transaction.purchase_order_number" class="mt-4 p-4 bg-sky-500/5 border border-sky-500/10 rounded-xl flex items-center justify-between group cursor-pointer hover:border-sky-500/30 transition-all"
                                     @click="jumpToPo(transaction.purchase_order_id)">
                                    <div class="flex flex-col">
                    ...
                    <!-- Right Section: Line Items Detail -->
                    <div class="col-span-12 lg:col-span-8 flex flex-col gap-8">
                        <section class="bg-zinc-900/60 border border-zinc-800 rounded-2xl overflow-hidden shadow-2xl backdrop-blur-sm">
                            ...
                            >
                                ...
                                <Column header="Stock Value" style="width: 150px">
                                    <template #body="{ data }">
                        ...
                        <!-- Bottom Signature Sector -->
                        <div class="grid grid-cols-2 gap-8 mt-4 opacity-50">
