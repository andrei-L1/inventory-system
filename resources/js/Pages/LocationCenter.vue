        ...
        <div class="p-4 bg-deep min-h-[calc(100vh-64px)] flex flex-col">
            ...
            <div class="max-w-[1600px] w-full mx-auto mb-6 flex justify-between items-end">
                <div class="flex flex-col">
                    ...
                    <p class="text-secondary text-sm max-w-2xl leading-relaxed">Manage your warehouse organizational hierarchy, bins, and storage zones across the global infrastructure.</p>
                </div>
            ...
            <div class="max-w-[1600px] w-full mx-auto grid grid-cols-12 gap-4 items-start flex-1 min-h-0">
                 ...
                 <aside class="col-span-12 lg:col-span-4 lg:sticky lg:top-[100px] lg:h-[calc(100vh-120px)] flex flex-col min-h-0 bg-panel/40 border border-panel-border/80 rounded-2xl overflow-hidden shadow-2xl backdrop-blur-sm">
                     <div class="p-4 border-b border-panel-border bg-panel/60">
                         <div class="flex items-center gap-3 mb-3">
                             <div class="w-2 h-2 rounded-full bg-sky-500"></div>
                             <span class="text-[10px] font-bold text-zinc-500 tracking-[0.25em] uppercase font-mono leading-none">Nodal Hierarchy</span>
                         </div>
                         <div class="relative">
                             ...
                             <InputText 
                                 ...
                                 @input="loadLocations"
                                 class="!w-full !pl-11 !pr-4 !bg-deep !border-panel-border !text-primary !h-10 !text-xs !rounded-xl focus:!border-sky-500/30 transition-all font-mono"
                             />
                         </div>
                     </div>
                     ...
                     <div class="flex-1 overflow-y-auto custom-scrollbar p-4">
                        ...
                        <div v-else class="space-y-2">
                            <div v-for="loc in locations" :key="loc.id" 
                                 ...
                                 class="p-3 rounded-xl border border-transparent hover:bg-panel-hover/50 hover:border-zinc-700 cursor-pointer transition-all flex items-center justify-between group">
                                 <div class="flex flex-col">
                                     <span class="text-xs font-bold text-zinc-500">{{ loc.name }}</span>
                                     <span class="text-[9px] text-secondary font-mono uppercase">{{ loc.code }}</span>
                                 </div>
                                 <i class="pi pi-chevron-right text-[10px] text-muted group-hover:text-sky-500"></i>
                            </div>
                        </div>
                     </div>
                </aside>
                ...
                <!-- Right Sector: Control Plane -->
                 <main class="col-span-12 lg:col-span-8 flex flex-col gap-4 min-h-0">
                     ...
                     <!-- Selection View -->
                     <section v-if="viewMode === 'details' && selectedLocation" class="bg-panel/40 border border-panel-border/80 rounded-2xl p-5 backdrop-blur-sm shadow-2xl transition-all duration-500 group overflow-hidden relative">
            ...
            >
                <div class="bg-deep border border-panel-border rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden animate-in fade-in zoom-in duration-500 ring-1 ring-white/5">
                        ...
                        <div class="grid grid-cols-12 gap-x-6 gap-y-6">
                            ...
                            <div class="col-span-12 md:col-span-6 flex flex-col gap-2">
                                ...
                                <Select v-model="locationForm.location_type_id" :options="locationTypes" optionLabel="name" optionValue="id" placeholder="Select Type" 
                                        class="!bg-panel/50 !border-panel-border !text-zinc-500 !h-12 focus:!border-sky-500/30" 
                                        :pt="{ 
                            ...
                            <div class="col-span-12 flex flex-col gap-2">
                                ...
                                <InputText v-model="locationForm.address" placeholder="123 Storage Way" class="!bg-panel/50 !border-panel-border !text-zinc-500 !h-12 focus:!border-sky-500/30" />
                            </div>

                            <div class="col-span-12 md:col-span-6 flex flex-col gap-2">
                                <label class="text-[10px] font-bold text-secondary uppercase tracking-widest font-mono">City</label>
                                <InputText v-model="locationForm.city" placeholder="City Name" class="!bg-panel/50 !border-panel-border !text-zinc-500 !h-12 focus:!border-sky-500/30" />
                            </div>
                            <div class="col-span-12 md:col-span-6 flex flex-col gap-2">
                                <label class="text-[10px] font-bold text-secondary uppercase tracking-widest font-mono">Country</label>
                                <InputText v-model="locationForm.country" placeholder="Country Name" class="!bg-panel/50 !border-panel-border !text-zinc-500 !h-12 focus:!border-sky-500/30" />
                            </div>
                    ...
                    <!-- Footer -->
                    <div class="px-8 py-6 border-t border-zinc-900 bg-panel/50 flex justify-end gap-3 items-center">
